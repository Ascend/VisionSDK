...
#ifndef MXBASE_OPENCVPLUGIN_H
#define MXBASE_OPENCVPLUGIN_H
...
class MxpiSamplePlugin : public MxTools::MxPluginBase
{
   public:
    ...
    APP_ERROR openCV(size_t idx, const MxTools::MxpiVision srcMxpiVision, MxTools::MxpiVision& dstMxpiVision);
    ...
    void Judge(auto& visionData, auto& visionInfo, cv::Mat& imgBgr, MxBase::MemoryData memorySrc, cv::Mat& src,
