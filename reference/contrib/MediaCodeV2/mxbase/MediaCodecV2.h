...
APP_ERROR CallBackVencode(std::shared_ptr<uint8_t>& outDataPtr, uint32_t& outDataSize, uint32_t& channelId,
...
class MediaCodecv2
{
   ...
   public:
    ...
    std::atomic<unsigned int> finishCount{0};
    std::atomic<unsigned int> lastCount{0};
