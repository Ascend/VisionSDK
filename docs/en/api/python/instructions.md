...
>- For overloaded functions in this section, such as [SendData](./process_orchestration.md#senddata), or functions with default values, such as [get_result](./process_orchestration.md#ZH-CN_TOPIC_0000001813201264), the parameter names in the function are defined only to describe parameter meanings. The actual function input parameter definition is `*args`. When you pass parameters, do not specify parameter names.
