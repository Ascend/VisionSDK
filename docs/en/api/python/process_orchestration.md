...
|Data Structure|Description|
|--|--|
|MxDataOutput|Inference service output data. For the type, see [MxDataOutput](./python_enumeration_types_and_data_classes.md#mxdataoutput).|
...
#### `get_result`<a id="ZH-CN_TOPIC_0000001813201264"></a>
