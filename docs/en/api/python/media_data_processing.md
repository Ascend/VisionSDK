...
2. Paste the cropped image into the specified paste area of `pastedImage`. For input and output formats, resolution ranges, and alignment rules, see [CropAndPaste](../cpp/media_data_processing.md#cropandpaste).
