...
> [!NOTE]
>
>- The scope of classes that allocate device-side resources, such as [Tensor](./media_data_processing.md#ZH-CN_TOPIC_0000001813201172), [Model](./model_inference.md#ZH-CN_TOPIC_0000001813201248), [Image](./media_data_processing.md#ZH-CN_TOPIC_0000001813201280), [ImageProcessor](./media_data_processing.md#ZH-CN_TOPIC_0000001860120493), [VideoEncoder](./media_data_processing.md#ZH-CN_TOPIC_0000001813360488), and [VideoDecoder](./media_data_processing.md#ZH-CN_TOPIC_0000001860120573), conflicts with the scope of `mx_deinit()`. Therefore, the scope of these classes cannot be greater than or equal to the scope of `mx_deinit()`.
