...
#ifndef MXPLUGINS_MXPISEMANTICSEGPOSTPROCESSOR_H
#define MXPLUGINS_MXPISEMANTICSEGPOSTPROCESSOR_H
#include <atomic>
#include <tuple>
...
/**
 * This plugin is used for loading semantic segmentation modelPostProcessor and write results in metadata.
 */
namespace MxPlugins {
class MxpiSemanticSegPostProcessor : public MxTools::MxImagePostProcessorBase {
public:
    /**
    ...
    */
    ...
    /**
    * @description: MxpiSemanticSegPostProcessor plugin process.
    ...
    */
    ...
    /**
    * @description: MxpiSemanticSegPostProcessor plugin define properties.
    * @return: properties.
    */
...
#endif // MXPLUGINS_MXPISEMANTICSEGPOSTPROCESSOR