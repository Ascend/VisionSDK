...
#ifndef MXPLUGINS_MXPITEXTOBJECTPOSTPROCESSOR
#define MXPLUGINS_MXPITEXTOBJECTPOSTPROCESSOR
...
/**
 * This plugin is used for loading text object detection modelPostProcessor and write results in metadata.
 */
namespace MxPlugins {
class MxpiTextObjectPostProcessor : public MxTools::MxImagePostProcessorBase {
public:
    /**
    ...
    */
    ...
    /**
    * @description: MxpiTextObjectPostProcessor plugin process.
    ...
    */
    ...
    /**
    * @description: MxpiTextObjectPostProcessor plugin define properties.
    * @return: properties.
    */
...
#endif // MXPLUGINS_MXPITEXTOBJECTPOSTPROCESSOR