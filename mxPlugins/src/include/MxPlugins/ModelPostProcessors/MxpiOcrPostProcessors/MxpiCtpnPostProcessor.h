...
#ifndef MXSDK_MXPICTPNPOSTPROCESSOR_H
#define MXSDK_MXPICTPNPOSTPROCESSOR_H
...
class MxpiCtpnPostProcessor : public MxPlugins::MxpiObjectPostProcessorBase {
public:
...
private:
    MxBase::CtpnPostProcessor ctpnPostProcessorInstance_;
};
...
#endif // MXSDK_MXPICTPNPOSTPROCESSOR_H
