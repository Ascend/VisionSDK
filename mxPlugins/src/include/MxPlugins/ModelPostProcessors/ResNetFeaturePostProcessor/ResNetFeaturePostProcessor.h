...
#ifndef MXPLUGINS_RESNETFEATUREPOSTPROCESSOR_H
#define MXPLUGINS_RESNETFEATUREPOSTPROCESSOR_H
...
class ResNetFeaturePostProcessor : public MxPlugins::MxpiModelPostProcessorBase {
public:
...
private:
    ...
    float ActivateOutput(float data);
...
#endif // RESNETFEATUREPOSTPROCESSOR_H