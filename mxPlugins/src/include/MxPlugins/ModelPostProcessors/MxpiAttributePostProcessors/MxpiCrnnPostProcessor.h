...
#ifndef MXPLUGINS_CRNNPOSTPROCESSOR_H
#define MXPLUGINS_CRNNPOSTPROCESSOR_H
...
class MxpiCrnnPostProcessor : public MxPlugins::MxpiModelPostProcessorBase {
public:
...
private:
    MxBase::CrnnPostProcessor crnnPostProcessor_;
};
...
#endif // MXPLUGINS_CRNNPOSTPROCESSOR_H