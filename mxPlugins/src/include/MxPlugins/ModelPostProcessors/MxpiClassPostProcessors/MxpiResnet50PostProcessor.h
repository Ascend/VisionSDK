...
class MxpiResnet50PostProcessor : public MxPlugins::MxpiModelPostProcessorBase {
public:
...
private:
    MxBase::Resnet50PostProcessor resnet50PostProcessor_;
};
...
#endif // MXPLUGINS_RESNET50POSTPROCESSOR_H