...
namespace {
ExportPluginRegister(mxpi_textobjectpostprocessor)
void Init()
{
...
TEST_F(TestMxpiTextObjectPostProcessor, TestMxpiTextObjectPostProcessor_Should_Return_Success_When_Param_Valid)
{
    std::map<std::string, std::string> properties = {
        {"dataSource", "mxpi_tensorinfer0"},
        {"postProcessConfigPath", "../models/ctpn_ms_cv/ctpn_mindspore.cfg"},
        {"postProcessLibPath", "../../../../../../mxBase/dist/lib/modelpostprocessors/libctpnpostprocess.so"},
    };
    auto pluginPtr =
...
TEST_F(TestMxpiTextObjectPostProcessor, TestMxpiTextObjectPostProcessor_Should_Return_Success_When_Python)
{
    std::map<std::string, std::string> properties = {
        {"dataSource", "mxpi_tensorinfer0"},
        {"funcLanguage", "python"},
