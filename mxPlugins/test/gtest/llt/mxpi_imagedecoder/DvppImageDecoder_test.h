...
#ifndef MXPLUGINS_MXPIIMAGEDECODER_DT_H
#define MXPLUGINS_MXPIIMAGEDECODER_DT_H

/**
 * MxpiImageDecoder's DT
 */

// nothing to export now, maybe this chain function can be used by other.
