...
TEST_F(TestMxpiChannelImagesStitcher, TestMxpiChannelImagesStitcher_Should_Return_Success_When_Single_Pad)
{
    std::map<std::string, std::string> properties = {
        {"dataSource", "mxpi_channeldistributor0_0"},
        {"channelIds", "0,1"},
        {"outputWidth", "1920"},
        {"outputHeight", "1080"},
    };
    ...
    pluginPtr->elementName_ = "mxpi_channelimagesstitcher0";
    pluginPtr->outputDataKeys_ = {"mxpi_channelimagesstitcher0_0"};
    std::vector<MxpiBuffer*> bufferVec;
    PluginTestHelper::GetMxpiBufferFromFiles({"./mxpi_channeldistributor0_0.json"}, bufferVec);
    auto ret = pluginPtr->Process(bufferVec);
    EXPECT_EQ(ret, APP_ERR_OK);
    ret = pluginPtr->DeInit();
    EXPECT_EQ(ret, APP_ERR_OK);
...
TEST_F(TestMxpiChannelImagesStitcher, TestMxpiChannelImagesStitcher_Should_Return_Success_When_RGBValue_Exist)
{
    std::map<std::string, std::string> properties = {
        {"dataSource", "mxpi_channeldistributor0_0, mxpi_channeldistributor0_1"},
        {"channelIds", "0,1"},
...
TEST_F(TestMxpiChannelImagesStitcher, TestMxpiChannelImagesStitcher_Should_Return_Fail_When_Properties_Empty)
{
    std::map<std::string, std::string> properties = {};
    int dynamicPorts = 2;
    auto pluginPtr = PluginTestHelper::GetPluginInstance<MxpiChannelImagesStitcher>("mxpi_channelimagesstitcher",
