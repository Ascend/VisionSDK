...
* -------------------------------------------------------------------------
 * Description: MxpiParallel2SerialTest.
 * Author: MindX SDK
 * Create: 2021
 * History: NA
 */
...
namespace {
class MxpiParallel2SerialTest : public testing::Test {
public:
    virtual void SetUp()
    {
...
TEST_F(MxpiParallel2SerialTest, TestParallel2SerialSinkNumOne)
{
    LogInfo << "********case1  TestParallel2Serial(sinknum=1)********";
    ...
    std::string streamName = "parallel2serial";
