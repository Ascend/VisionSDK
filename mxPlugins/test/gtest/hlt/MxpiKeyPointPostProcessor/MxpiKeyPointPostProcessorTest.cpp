...
namespace {
    class MxpiKeyPointPostProcessorTest : public testing::Test {
    public:
        virtual void SetUp()
        {
    ...
    TEST_F(MxpiKeyPointPostProcessorTest, DISABLED_TestBasic)
    {
        ...
        APP_ERROR ret = mxStreamManager.CreateMultipleStreamsFromFile("KeyPointPostProcessor.pipeline");
        ...
        std::string streamName = "openpose";
        ...
        std::string result = FileUtils::ReadFileContent("keypointpostprocessor.output");
