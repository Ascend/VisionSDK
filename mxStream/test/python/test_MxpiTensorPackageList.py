...
See the Mulan PSL v2 for more details.
-------------------------------------------------------------------------
Description: tensor packager list test.
Author: Vision SDK
Create: 2021
History: NA
"""
...
import json
import logging
from StreamManagerApi import MxDataInput, MxProtobufIn, InProtobufVector, StringVector, StreamManagerApi
...
if __name__ == '__main__':
    ...
    tensorPackageVec = mxpiTensorPackageList.tensorPackageVec.add() 
    tensorVec = tensorPackageVec.tensorVec.add()
    ...
    protobuf.protobuf = mxpiTensorPackageList.SerializeToString()
    ...
    with open("result.jpg", "wb") as fo:
        fo.write(result.tensorPackageVec[0].tensorVec[0].dataStr)
    # Inputs data to a specified stream based on streamName.
