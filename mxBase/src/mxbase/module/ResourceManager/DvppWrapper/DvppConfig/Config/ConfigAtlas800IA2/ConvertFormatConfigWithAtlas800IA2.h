 ...
 * History: NA
 */
#ifndef MXBASE_CONVERTFORMATCONFIGWITHATLAS800IA2_H
#define MXBASE_CONVERTFORMATCONFIGWITHATLAS800IA2_H
#include "MxBase/E2eInfer/DataType.h"
#include "ResourceManager/DvppWrapper/DvppConfig/Config/ConvertFormatConfig.h"

namespace MxBase {
class ConvertFormatConfigForYUVAndYVUWithAtlas800IA2 : public ConvertFormatConfig {
public:
...
class ConvertFormatConfigForRGBAndBGRWithAtlas800IA2 : public ConvertFormatConfig {
public:
