...
#ifndef MXBASE_CROPCONFIGWITH310P_H
#define MXBASE_CROPCONFIGWITH310P_H
#include "MxBase/E2eInfer/DataType.h"
#include "ResourceManager/DvppWrapper/DvppConfig/Config/CropConfig.h"

namespace MxBase {
class CropConfigForYUVAndYVUWith310P : public CropConfig {
public:
...
class CropConfigForRGBAndBGRWith310P : public CropConfig {
public:
