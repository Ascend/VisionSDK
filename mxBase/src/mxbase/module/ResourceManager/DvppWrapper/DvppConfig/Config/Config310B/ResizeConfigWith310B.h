...
#ifndef MXBASE_RESIZECONFIGWITH310B_H
#define MXBASE_RESIZECONFIGWITH310B_H
#include "MxBase/E2eInfer/DataType.h"
#include "ResourceManager/DvppWrapper/DvppConfig/Config/ResizeConfig.h"

namespace MxBase {
class ResizeConfigForYUVAndYVUWith310B : public ResizeParamConfig {
public:
...
class ResizeConfigForRGBAndBGRWith310B : public ResizeParamConfig {
public:
    APP_ERROR ResizeCheck(const DvppDataInfo& inputData, const ResizeConfig& resizeConfig)
    {
        return checkPtr_->Check(inputData, resizeConfig, config_);
