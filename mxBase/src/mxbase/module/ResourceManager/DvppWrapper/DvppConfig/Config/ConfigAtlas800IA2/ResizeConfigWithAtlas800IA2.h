...
#ifndef MXBASE_RESIZECONFIGWITHATLAS800IA2_H
#define MXBASE_RESIZECONFIGWITHATLAS800IA2_H
#include "MxBase/E2eInfer/DataType.h"
#include "ResourceManager/DvppWrapper/DvppConfig/Config/ResizeConfig.h"

namespace MxBase {
class ResizeConfigForYUVAndYVUWithAtlas800IA2 : public ResizeParamConfig {
public:
...
class ResizeConfigForRGBAndBGRWithAtlas800IA2 : public ResizeParamConfig {
public:
    APP_ERROR ResizeCheck(const DvppDataInfo& inputData, const ResizeConfig& resizeConfig)
    {
        return checkPtr_->Check(inputData, resizeConfig, config_);
