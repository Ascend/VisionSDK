 ...
 * History: NA
 */
#ifndef MXBASE_CROPRESIZECONFIGWITH310P_H
#define MXBASE_CROPRESIZECONFIGWITH310P_H
#include "MxBase/E2eInfer/DataType.h"
#include "ResourceManager/DvppWrapper/DvppConfig/Config/CropResizeConfig.h"

namespace MxBase {
class CropResizeConfigForYUVAndYVUWith310P : public CropResizeConfig {
public:
...
class CropResizeConfigForRGBAndBGRWith310P : public CropResizeConfig {
public:
    APP_ERROR CropResizeCheck(const DvppDataInfo &inputData,
                              CropRoiConfig &cropRect,
                              const ResizeConfig &resizeScale)
