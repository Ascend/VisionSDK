...
#ifndef MXBASE_CROPCONFIGWITH310_H
#define MXBASE_CROPCONFIGWITH310_H
#include "MxBase/E2eInfer/DataType.h"
#include "ResourceManager/DvppWrapper/DvppConfig/Config/CropConfig.h"

namespace MxBase {
class CropConfigForYUVAndYVUWith310 : public CropConfig {
public:
...
public:
    APP_ERROR CropCheck(const DvppDataInfo& inputInfo,
                        std::vector<CropRoiConfig>& cropAreaVec, uint32_t cropAreaNum,
                        uint32_t inputImageNum, uint32_t outputImageNum)
    {
