 ...
 * History: NA
 */
#ifndef MXBASE_ENCODECONFIGWITH310P_H
#define MXBASE_ENCODECONFIGWITH310P_H
#include "MxBase/E2eInfer/DataType.h"
#include "ResourceManager/DvppWrapper/DvppConfig/Config/EncodeConfig.h"

namespace MxBase {
class EncodeConfigForYUVAndYVUWith310P : public EncodeConfig {
public:
...
class EncodeConfigForRBGAndBGRWith310P : public EncodeConfig {
public:
    APP_ERROR EncodeCheck(const DvppDataInfo& inputData, uint32_t encodeLevel)
    {
        return checkPtr_->Check(inputData, encodeLevel, config_);
