...
#ifndef MXBASE_SSDVGGPOSTPROCESSOR_H
#define MXBASE_SSDVGGPOSTPROCESSOR_H
...
namespace MxBase {
class SDK_DEPRECATED_FOR() SsdvggPostProcessor : public MxBase::ObjectPostProcessorBase {
public:
    /*
...
#endif // MXBASE_SSDVGGPOSTPROCESSOR_H