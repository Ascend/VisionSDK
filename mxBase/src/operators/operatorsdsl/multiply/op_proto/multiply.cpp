...
IMPLEMT_COMMON_INFERFUNC(MultiplyInferShape)
{
...
IMPLEMT_VERIFIER(Multiply, MultiplyVerify)
{
    return GRAPH_SUCCESS;
}

COMMON_INFER_FUNC_REG(Multiply, MultiplyInferShape);
VERIFY_FUNC_REG(Multiply, MultiplyVerify);
}  // namespace ge
