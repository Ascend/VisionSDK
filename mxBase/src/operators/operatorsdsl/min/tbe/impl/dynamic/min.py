...
@register_operator_compute("min", op_mode="dynamic", support_fusion=False)
def min_compute(x1, x2):
    """
...
def min(x1, x2, y, kernel_name="min"):
    """
    To do: Implement the operator by referring to the
           TBE Operator Development Guide.
    """
    ...
    for _x1, _x2 in ins:
        with tbe.compute():
            ...
            res = min_compute(x1_input, x2_input)
