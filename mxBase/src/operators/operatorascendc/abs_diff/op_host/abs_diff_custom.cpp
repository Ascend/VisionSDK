...
#include "abs_diff_custom_tiling.h"
...
namespace ops {
    class AbsDiffCustom : public OpDef {
    public:
        explicit AbsDiffCustom(const char* name) : OpDef(name)
        {
            this->Input("x")
                    .ParamType(REQUIRED)
