...
__aicore__ inline size_t UpAlignN(size_t n, size_t N) { return (n + N - 1) / N * N; }

__aicore__ inline size_t DownAlignN(size_t n, size_t N) { return n / N * N; }
...
{
   public:
    __aicore__ inline ResizeScheduler(size_t blockDim, size_t bufferNum, size_t ubVarCount, size_t channels,
                                      size_t dstWidth, size_t dstHeight, size_t srcWidth, size_t srcHeight,
                                      size_t sizeofT, bool isLinear = false)
