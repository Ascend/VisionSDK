...
#include "scale_add_custom_tiling.h"
...
namespace ops {
    class ScaleAddCustom : public OpDef {
    public:
        explicit ScaleAddCustom(const char* name) : OpDef(name)
        {
            this->Input("x")
                .ParamType(REQUIRED)
